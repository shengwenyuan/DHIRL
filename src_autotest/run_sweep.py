#!/usr/bin/env python
"""
Data-efficiency sweep runner — reads a YAML config and launches
train_labyrinth_b_sweep.py experiments with full logging.
...
TRAIN_MODULE = 'src_autotest.train_labyrinth_b_sweep'
...
def main():
    parser = argparse.ArgumentParser(description='Data-efficiency sweep runner')
    ...
    with open(summary_path, 'w') as sf:
        sf.write(f'Sweep Summary  {timestamp}\n')
        sf.write('=' * 72 + '\n')
